...
public class ClientBiomeCache {
   ...
   private static Path getFile() {
      return Minecraft.getInstance().gameDirectory.toPath().resolve("chicken_biomes.json");
   }
   ...
   public static synchronized void reloadFromDisk() {
      ...
      if (Files.exists(file)) {
         try (Reader reader = Files.newBufferedReader(file)) {
            ...
            Map<String, List<String>> data = (Map<String, List<String>>)GSON.fromJson(reader, type);
            if (data != null) {
