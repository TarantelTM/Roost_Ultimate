...
public class ChickenRendererBreeder implements BlockEntityRenderer<breeder_entity> {


    public ChickenRendererBreeder(BlockEntityRendererFactory.Context context){

    }
    @Override
    public void render(breeder_entity entity, float tickDelta, MatrixStack matrices,
        ...
        switch (entity.getCachedState().get(breeder_block.FACING)) {
            //DONE
            case NORTH -> {
