...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FEEDER = registerBlock("feeder",
            () -> new Feeder_Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)
                    .strength(1f).noOcclusion()));

    public static final RegistryObject<Block> COLLECTOR = registerBlock("collector",
            () -> new Collector_Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)
                    .strength(1f).noOcclusion()));
    ...
    public static final RegistryObject<Block> TORCH = BLOCKS.register("chicken_torch",
            () -> new TorchBlock(BlockBehaviour.Properties.of().noCollission().instabreak().lightLevel((p_50755_) -> 14).sound(SoundType.WOOD).pushReaction(PushReaction.DESTROY), ParticleTypes.DRAGON_BREATH));

    public static final RegistryObject<Block> WALL_TORCH = registerBlock("chicken_wall_torch",
            () -> new ModWallTorchBlock(BlockBehaviour.Properties.of().noCollission().instabreak().lightLevel((p_50886_) -> 14).sound(SoundType.WOOD).pushReaction(PushReaction.DESTROY), ParticleTypes.DRAGON_BREATH, TORCH));
