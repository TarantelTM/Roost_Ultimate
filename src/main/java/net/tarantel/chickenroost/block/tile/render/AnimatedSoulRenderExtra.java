...
//
//public class AnimatedSoulRenderExtra implements BlockEntityRenderer<Soul_Extractor_Tile> {
//    public AnimatedSoulRenderExtra(BlockEntityRendererProvider.Context context) {
//
//    }
//
//    @Override
//    public void render(Soul_Extractor_Tile pBlockEntity, float pPartialTick, PoseStack pPoseStack,
...
//
//
//        switch (pBlockEntity.getBlockState().getValue(Soul_Extractor_Block.FACING)) {
//            case NORTH -> {
