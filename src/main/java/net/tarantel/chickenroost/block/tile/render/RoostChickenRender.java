...
public class RoostChickenRender implements BlockEntityRenderer<RoostTile> {
   public RoostChickenRender(Context context) {
   }

   public void render(
      RoostTile pBlockEntity, float pPartialTick, PoseStack pPoseStack, @NotNull MultiBufferSource pBufferSource, int pPackedLight, int pPackedOverlay
   ) {
