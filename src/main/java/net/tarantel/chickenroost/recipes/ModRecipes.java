...
public class ModRecipes {
    ...
    public static final Supplier<RecipeSerializer<SoulExtractorRecipe>> SOUL_EXTRACTION_SERIALIZER =
            RECIPE_SERIALIZERS.register("soul_extraction", () -> SoulExtractorRecipe.Serializer.INSTANCE);
    public static final Supplier<RecipeSerializer<RoostRecipe>> ROOST_SERIALIZER =
            RECIPE_SERIALIZERS.register("roost_output", () -> RoostRecipe.Serializer.INSTANCE);
