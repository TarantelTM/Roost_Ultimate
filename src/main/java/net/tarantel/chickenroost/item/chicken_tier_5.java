...
public class chicken_tier_5 extends Item {
	...
	public chicken_tier_5(Settings settings) {
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		...
		tooltip.add(Text.literal("\u00A71" + "Tier: " + "\u00A79" + "5"));
		tooltip.add(Text.literal((("\u00A7e") + "Level: " + "\u00A79" + ((roost_chickenlevel)) + "/" + (((int) Config.maxlevel_tier_5.get())))));
		tooltip.add(Text.literal((("\u00A7a") + "XP: " + "\u00A79" + ((roost_chickenxp)) + "/" + (((int) Config.xp_tier_5.get())))));
