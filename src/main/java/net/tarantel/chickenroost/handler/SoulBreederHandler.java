...
public class SoulBreederHandler extends AbstractContainerMenu {


    public final SoulBreederTile blockEntity;
    ...
    public SoulBreederHandler(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));

    }

    public SoulBreederHandler(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModHandlers.SOUL_BREEDER_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (SoulBreederTile) entity;
    ...
    public boolean stillValid(@NotNull Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.SOUL_BREEDER.get());
    }
