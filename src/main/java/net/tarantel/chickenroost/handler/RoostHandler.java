...
public class RoostHandler extends AbstractContainerMenu {
   ...
   public RoostHandler(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      ...
      this.blockEntity = (RoostTile)entity;
      ...
      ItemCapabilityMenuHelper.getCapabilityItemHandler(this.level, this.blockEntity).ifPresent(itemHandler -> {
         ...
         this.addSlot(new SlotItemHandler(itemHandler, 1, 39, 19) {
            public boolean mayPlace(@NotNull ItemStack stack) {
               return stack.getItem() instanceof ChickenItemBase;
            }
         });
         this.addSlot(new SlotItemHandler(itemHandler, 2, 120, 19) {
            public boolean mayPlace(@NotNull ItemStack stack) {
               return false;
            }
         });
   ...
   public boolean stillValid(@NotNull Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.ROOST.get());
   }
