...
public class BreederHandler extends AbstractContainerMenu {
   ...
   public BreederHandler(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      ...
      this.blockEntity = (BreederTile)entity;
   ...
   public boolean stillValid(@NotNull Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.BREEDER.get());
   }
