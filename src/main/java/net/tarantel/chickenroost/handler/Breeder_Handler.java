...
public class Breeder_Handler extends AbstractContainerMenu {
    ...
    public Breeder_Handler(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 24, 43){
                @Override
            ...
            this.addSlot(new SlotItemHandler(handler, 2, 39, 19){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return (stack.getItem() instanceof ChickenItemBase);
                }
            ...
            this.addSlot(new SlotItemHandler(handler, 3, 100, 7){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 4, 126, 7){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 5, 153, 7){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 6, 100, 30){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 7, 126, 30){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 8, 153, 30){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 9, 100, 54){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 10, 126, 54){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
            });
            this.addSlot(new SlotItemHandler(handler, 11, 153, 54){
                @Override
                public boolean mayPlace(@NotNull ItemStack stack) {
                    return false;
                }
