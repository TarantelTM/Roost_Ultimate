...
public class TrainerHandler extends AbstractContainerMenu {
   ...
   public TrainerHandler(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      ...
      this.blockEntity = (TrainerTile)entity;
   ...
   public boolean stillValid(@NotNull Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.TRAINER.get());
   }
