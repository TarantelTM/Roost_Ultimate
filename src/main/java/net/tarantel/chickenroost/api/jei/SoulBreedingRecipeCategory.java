...
public class SoulBreedingRecipeCategory implements IRecipeCategory<SoulBreederRecipe> {
    ...
    public static final RecipeType<SoulBreederRecipe> RECIPE_TYPE = new RecipeType<>(UID, SoulBreederRecipe.class);
    ...
    @Override
    public RecipeType<SoulBreederRecipe> getRecipeType() {
    ...
    @Override
    public void draw(SoulBreederRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, SoulBreederRecipe recipe, @NotNull IFocusGroup focuses) {
