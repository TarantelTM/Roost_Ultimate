...
public class BreederRecipeCategory implements IRecipeCategory<BreederRecipe> {
   public static final ResourceLocation UID = ChickenRoostMod.ownresource("basic_breeding");
   ...
   public static final RecipeType<BreederRecipe> RECIPE_TYPE = RecipeType.create("chicken_roost", "basic_breeding", BreederRecipe.class);
   ...
   public BreederRecipeCategory(IGuiHelper helper) {
      ...
      this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack((ItemLike)ModBlocks.BREEDER.get()));
   ...
   public void setRecipe(@NotNull IRecipeLayoutBuilder builder, BreederRecipe recipe, @NotNull IFocusGroup focuses) {
      builder.addSlot(RecipeIngredientRole.INPUT, 21, 1).addIngredients((Ingredient)recipe.getIngredients().get(0));
      builder.addSlot(RecipeIngredientRole.INPUT, 0, 1).addIngredients((Ingredient)recipe.getIngredients().get(1));
      builder.addSlot(RecipeIngredientRole.INPUT, 41, 1).addIngredients((Ingredient)recipe.getIngredients().get(2));
