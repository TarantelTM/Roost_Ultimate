...
public class RoostREICategoryV1 implements DisplayCategory<RoostREIDisplayV1> {
    private final EntryStack<ItemStack> blaster = EntryStacks.of(new ItemStack(ModBlocks.ROOST));

    @Override
    public CategoryIdentifier<RoostREIDisplayV1> getCategoryIdentifier() {
        return RoostREIDisplayV1.ID;
    }
