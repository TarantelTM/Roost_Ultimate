...
//        helper.beginRecipeFiller(ThrowEggRecipe.class, ThrowEggRecipe.Type.INSTANCE, EggREIDisplay::new);
//        helper.registerDisplayGenerator(BreederRecipe.class, BreederRecipe.Type.INSTANCE, BreederREIDisplay::new);
//        helper.registerDisplayGenerator(RoostRecipe.class, RoostRecipe.Type.INSTANCE, RoostREIDisplay::new);
//        helper.registerDisplayGenerator(SoulExtractorRecipe.class, SoulExtractorRecipe.Type.INSTANCE, SoulExtractionREIDisplay::new);
//        helper.registerDisplayGenerator(TrainerRecipe.class, TrainerRecipe.Type.INSTANCE, TrainerREIDisplay::new);
//    }
//
//    @Override
...
//        registry.register(Identifier.fromNamespaceAndPath(ChickenRoostMod.MODID, "basic_breeding"), BreederREIDisplay.SERIALIZER);
//        registry.register(Identifier.fromNamespaceAndPath(ChickenRoostMod.MODID, "throwegg"), EggREIDisplay.SERIALIZER);
//        registry.register(Identifier.fromNamespaceAndPath(ChickenRoostMod.MODID, "roost_output"), RoostREIDisplay.SERIALIZER);
//        registry.register(Identifier.fromNamespaceAndPath(ChickenRoostMod.MODID, "soul_extraction"), SoulExtractionREIDisplay.SERIALIZER);
//        registry.register(Identifier.fromNamespaceAndPath(ChickenRoostMod.MODID, "trainer_output"), TrainerREIDisplay.SERIALIZER);
//
//    }
//}