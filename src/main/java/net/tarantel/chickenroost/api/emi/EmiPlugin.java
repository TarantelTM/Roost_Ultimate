...
public class EmiPlugin implements dev.emi.emi.api.EmiPlugin {
    ...
    public static final EmiStack SOUL_BREEDER_WORKSTATION = EmiStack.of(ModBlocks.SOUL_BREEDER.get());
    ...
    public void register(EmiRegistry registry) {
        ...
        for (Soul_Breeder_Recipe soulbreed : manager.getAllRecipesFor(ModRecipes.SOUL_BREEDING_TYPE.get())) {
            registry.addRecipe(new EmiSoulBreederRecipe(soulbreed));
        }
