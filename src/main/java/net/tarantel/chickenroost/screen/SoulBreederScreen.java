...
public class SoulBreederScreen extends AbstractContainerScreen<SoulBreederHandler> {

    
    public SoulBreederScreen(SoulBreederHandler menu, Inventory inventory, Component component) {
