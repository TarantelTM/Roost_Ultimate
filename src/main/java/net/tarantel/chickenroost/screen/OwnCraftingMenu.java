...
public class OwnCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public OwnCraftingMenu(int p_39353_, Inventory p_39354_) {
        this(p_39353_, p_39354_, ContainerLevelAccess.NULL);
    }

    public OwnCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
    ...
    @Override
    public boolean recipeMatches(RecipeHolder<? extends Recipe<CraftingContainer>> p_300858_) {
