...
public class AChickenBasaltRenderer extends MobRenderer<AChickenBasaltEntity, Modelchicken<AChickenBasaltEntity>> {
	public AChickenBasaltRenderer(EntityRendererProvider.Context context) {
