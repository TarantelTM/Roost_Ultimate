...
public class AChickenCinnabarRenderer extends MobRenderer<AChickenCinnabarEntity, Modelchicken<AChickenCinnabarEntity>> {
	public AChickenCinnabarRenderer(EntityRendererProvider.Context context) {
