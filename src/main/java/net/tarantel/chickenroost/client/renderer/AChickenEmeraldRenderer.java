...
public class AChickenEmeraldRenderer extends MobRenderer<AChickenEmeraldEntity, Modelchicken<AChickenEmeraldEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenEmeraldEntity entity) {
		return new ResourceLocation("chicken_roost:textures/entities/emerald_chicken.png");
	}
}
