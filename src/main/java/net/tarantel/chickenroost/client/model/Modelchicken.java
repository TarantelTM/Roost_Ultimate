...
public class Modelchicken<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("chicken_roost", "modelchicken"), "main"
   );
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition comb = head.addOrReplaceChild(
         "comb",
      ...
      PartDefinition leg0 = partdefinition.addOrReplaceChild(
         "leg0",
      ...
      PartDefinition leg1 = partdefinition.addOrReplaceChild(
         "leg1",
         CubeListBuilder.create().texOffs(26, 0).addBox(-1.0F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(1.0F, 19.0F, 1.0F)
      );
      PartDefinition wing0 = partdefinition.addOrReplaceChild(
         "wing0",
      ...
      PartDefinition wing1 = partdefinition.addOrReplaceChild(
         "wing1",
   ...
   public void renderToBuffer(@NotNull PoseStack var1, @NotNull VertexConsumer var2, int var3, int var4, int var5) {
      this.body.render(var1, var2, var3, var4, -1);
      this.head.render(var1, var2, var3, var4, -1);
      this.leg0.render(var1, var2, var3, var4, -1);
      this.leg1.render(var1, var2, var3, var4, -1);
      this.wing0.render(var1, var2, var3, var4, -1);
      this.wing1.render(var1, var2, var3, var4, -1);
   }
