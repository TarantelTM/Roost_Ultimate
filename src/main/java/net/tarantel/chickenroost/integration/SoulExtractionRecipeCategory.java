...
public class SoulExtractionRecipeCategory implements IRecipeCategory<Soul_Extractor_Recipe> {
    public final static ResourceLocation UID = new ResourceLocation(ChickenRoostMod.MODID, "soul_extraction");
    ...
    public SoulExtractionRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(ModBlocks.SOUL_EXTRACTOR.get()));
    ...
    public RecipeType<Soul_Extractor_Recipe> getRecipeType() {
        return JEICompat.SOUL_EXTRACTION_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.nullToEmpty("Soul Extraction");
    }
    ...
    @Override
    public void draw(Soul_Extractor_Recipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public Class<? extends Soul_Extractor_Recipe> getRecipeClass() {
        return JEICompat.SOUL_EXTRACTION_TYPE.getRecipeClass();
    }
}