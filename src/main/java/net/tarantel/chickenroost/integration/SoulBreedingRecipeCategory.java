...
public class SoulBreedingRecipeCategory implements IRecipeCategory<Soul_Breeder_Recipe> {
    ...
    public SoulBreedingRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(ModBlocks.SOUL_BREEDER.get()));
    ...
    public RecipeType<Soul_Breeder_Recipe> getRecipeType() {
        return JEICompat.SOUL_BREEDING_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.nullToEmpty("Soul Breeding");
    }
    ...
    @Override
    public void draw(Soul_Breeder_Recipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public Class<? extends Soul_Breeder_Recipe> getRecipeClass() {
        return JEICompat.SOUL_BREEDING_TYPE.getRecipeClass();
    }
}