...
public class Model_c_netherite extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_netherite(EntityRendererFactory.Context context) {
