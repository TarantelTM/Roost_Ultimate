...
public class Model_c_netherstar extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_netherstar(EntityRendererFactory.Context context) {
