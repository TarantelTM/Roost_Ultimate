...
public class Model_c_glowberries extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_glowberries(EntityRendererFactory.Context context) {
