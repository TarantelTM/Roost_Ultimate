...
public class Model_c_netherquartz extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_netherquartz(EntityRendererFactory.Context context) {
