...
public class AChickencarrotEntity extends Chicken {
	...
	if((boolean) SpawnConfig.Spawn_Carrot.get() == true && (boolean)SpawnConfig.Spawn_All.get() == true){
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKENCARROT.get(), SpawnConfig.Carrot_Spawnweight.get(), SpawnConfig.Carrot_MinGroupsize.get(), SpawnConfig.Carrot_MaxGroupsize.get()));
	}
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKENCARROT.get(), SpawnPlacements.Type.ON_GROUND,
