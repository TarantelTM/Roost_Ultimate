...
public class Model_c_melon extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_melon(EntityRendererFactory.Context context) {
