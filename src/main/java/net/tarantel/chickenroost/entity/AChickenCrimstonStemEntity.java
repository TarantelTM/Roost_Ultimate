...
public class AChickenCrimstonStemEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_CRIMSTON_STEM.get(), 50, 1, 2));
	}

	public AChickenCrimstonStemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_CRIMSTON_STEM.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_CRIMSTON_STEM.get(), SpawnPlacements.Type.ON_GROUND,
