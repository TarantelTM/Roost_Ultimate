...
public class Model_c_sweetberries extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_sweetberries(EntityRendererFactory.Context context) {
