...
public class Model_c_vanilla extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_vanilla(EntityRendererFactory.Context context) {
