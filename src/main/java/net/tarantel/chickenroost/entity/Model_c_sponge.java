...
public class Model_c_sponge extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_sponge(EntityRendererFactory.Context context) {
