...
public class AChickenHoneycombEntity extends Chicken {
	...
	if((boolean) SpawnConfig.Spawn_Honeycomb.get() == true && (boolean)SpawnConfig.Spawn_All.get() == true){
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_HONEYCOMB.get(), SpawnConfig.Honeycomb_Spawnweight.get(), SpawnConfig.Honeycomb_MinGroupsize.get(), SpawnConfig.Honeycomb_MaxGroupsize.get()));
	}
	...
	public AChickenHoneycombEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_HONEYCOMB.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_HONEYCOMB.get(), SpawnPlacements.Type.ON_GROUND,
