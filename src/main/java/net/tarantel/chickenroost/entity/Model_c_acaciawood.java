...
public class Model_c_acaciawood  extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_acaciawood(EntityRendererFactory.Context context) {
