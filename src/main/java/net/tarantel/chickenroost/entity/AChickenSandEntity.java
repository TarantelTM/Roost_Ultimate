...
public class AChickenSandEntity extends Chicken {
	...
	if((boolean) SpawnConfig.Spawn_Sand.get() == true && (boolean)SpawnConfig.Spawn_All.get() == true){
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_SAND.get(), SpawnConfig.Sand_Spawnweight.get(), SpawnConfig.Sand_MinGroupsize.get(), SpawnConfig.Sand_MaxGroupsize.get()));
	}
	}


	public AChickenSandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_SAND.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_SAND.get(), SpawnPlacements.Type.ON_GROUND,
