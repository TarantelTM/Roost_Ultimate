...
public class AChickenNetherrackEntity extends Chicken {
	...
	if((boolean) SpawnConfig.Spawn_Netherrack.get() == true && (boolean)SpawnConfig.Spawn_All.get() == true){
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_NETHERRACK.get(), SpawnConfig.Netherrack_Spawnweight.get(), SpawnConfig.Netherrack_MinGroupsize.get(), SpawnConfig.Netherrack_MaxGroupsize.get()));
	}
	}


	public AChickenNetherrackEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_NETHERRACK.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_NETHERRACK.get(), SpawnPlacements.Type.ON_GROUND,
