...
public class AChickenBasaltEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_BASALT.get(), 50, 1, 2));
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_BASALT.get(), SpawnPlacements.Type.ON_GROUND,
