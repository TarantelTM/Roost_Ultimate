...
public class AChickenglowberriesEntity extends Chicken {

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
	if((boolean) SpawnConfig.Spawn_Glowberries.get() == true && (boolean) SpawnConfig.Spawn_All.get() == true){
		event.getSpawns().getSpawner(MobCategory.CREATURE)
				.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKENGLOWBERRIES.get(), SpawnConfig.Glowberries_Spawnweight.get(), SpawnConfig.Glowberries_MinGroupsize.get(), SpawnConfig.Glowberries_MaxGroupsize.get()));
	}
	}


	public AChickenglowberriesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKENGLOWBERRIES.get(), world);
	}

	public AChickenglowberriesEntity(EntityType<AChickenglowberriesEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKENGLOWBERRIES.get(), SpawnPlacements.Type.ON_GROUND,
