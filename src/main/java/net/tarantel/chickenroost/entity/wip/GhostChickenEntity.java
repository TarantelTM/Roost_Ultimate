...
public class GhostChickenEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public GhostChickenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.GHOST_CHICKEN.get(), world);
	}

	public GhostChickenEntity(EntityType<GhostChickenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
