...
public class AChickenQueenSlimeEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenQueenSlimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_QUEEN_SLIME.get(), world);
	}

	public AChickenQueenSlimeEntity(EntityType<AChickenQueenSlimeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
