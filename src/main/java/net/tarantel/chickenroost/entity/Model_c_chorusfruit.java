...
public class Model_c_chorusfruit extends MobEntityRenderer<ChickenBaseEntity, Modelchicken<ChickenBaseEntity>> {
    public Model_c_chorusfruit(EntityRendererFactory.Context context) {
