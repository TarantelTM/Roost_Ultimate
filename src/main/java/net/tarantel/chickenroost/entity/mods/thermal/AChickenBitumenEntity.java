...
public class AChickenBitumenEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBitumenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BITUMEN.get(), world);
	}

	public AChickenBitumenEntity(EntityType<AChickenBitumenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:bitumen"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
