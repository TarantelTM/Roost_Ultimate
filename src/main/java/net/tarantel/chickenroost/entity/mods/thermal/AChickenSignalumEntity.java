...
public class AChickenSignalumEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenSignalumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_SIGNALUM.get(), world);
	}

	public AChickenSignalumEntity(EntityType<AChickenSignalumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("chicken_roost:ingot_signalum"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
