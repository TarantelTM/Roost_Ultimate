...
public class AChickenAEChargedCertusEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenAEChargedCertusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_AE_CHARGED_CERTUS.get(), world);
	}

	public AChickenAEChargedCertusEntity(EntityType<AChickenAEChargedCertusEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ae2:charged_certus_quartz_crystal"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
