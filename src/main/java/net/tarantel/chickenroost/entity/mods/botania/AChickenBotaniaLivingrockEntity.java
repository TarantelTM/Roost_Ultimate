...
public class AChickenBotaniaLivingrockEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBotaniaLivingrockEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BOTANIA_LIVINGROCK.get(), world);
	}

	public AChickenBotaniaLivingrockEntity(EntityType<AChickenBotaniaLivingrockEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("botania:livingrock"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
