...
public class AChickenBronzeEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBronzeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_BRONZE.get(), world);
	}

	public AChickenBronzeEntity(EntityType<AChickenBronzeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
