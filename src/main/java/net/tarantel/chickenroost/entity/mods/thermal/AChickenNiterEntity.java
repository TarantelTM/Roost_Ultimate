...
public class AChickenNiterEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenNiterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_NITER.get(), world);
	}

	public AChickenNiterEntity(EntityType<AChickenNiterEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:niter"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
