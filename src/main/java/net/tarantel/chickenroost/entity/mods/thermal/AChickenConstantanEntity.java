...
public class AChickenConstantanEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenConstantanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_CONSTANTAN.get(), world);
	}

	public AChickenConstantanEntity(EntityType<AChickenConstantanEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:constantan_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
