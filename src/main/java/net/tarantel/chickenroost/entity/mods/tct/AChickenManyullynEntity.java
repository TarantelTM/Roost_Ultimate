...
public class AChickenManyullynEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenManyullynEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MANYULLYN.get(), world);
	}

	public AChickenManyullynEntity(EntityType<AChickenManyullynEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:manyullyn_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
