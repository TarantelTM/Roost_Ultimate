...
public class AChickenBotaniaManasteelEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBotaniaManasteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BOTANIA_MANASTEEL.get(), world);
	}
	public AChickenBotaniaManasteelEntity(EntityType<AChickenBotaniaManasteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("botania:manasteel_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
