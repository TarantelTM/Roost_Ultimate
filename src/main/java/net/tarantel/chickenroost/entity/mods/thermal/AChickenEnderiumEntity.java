...
public class AChickenEnderiumEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenEnderiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_ENDERIUM.get(), world);
	}

	public AChickenEnderiumEntity(EntityType<AChickenEnderiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("chicken_roost:ingot_enderium"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
