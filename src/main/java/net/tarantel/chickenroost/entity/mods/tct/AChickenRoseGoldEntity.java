...
public class AChickenRoseGoldEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenRoseGoldEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_ROSE_GOLD.get(), world);
	}

	public AChickenRoseGoldEntity(EntityType<AChickenRoseGoldEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:rose_gold_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
