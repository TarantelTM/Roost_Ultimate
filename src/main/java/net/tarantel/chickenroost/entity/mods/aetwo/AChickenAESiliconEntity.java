...
public class AChickenAESiliconEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenAESiliconEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_AE_SILICON.get(), world);
	}

	public AChickenAESiliconEntity(EntityType<AChickenAESiliconEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ae2:silicon"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
