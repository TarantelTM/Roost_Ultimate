...
public class AChickenHepatizonEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenHepatizonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_HEPATIZON.get(), world);
	}

	public AChickenHepatizonEntity(EntityType<AChickenHepatizonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:hepatizon_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
