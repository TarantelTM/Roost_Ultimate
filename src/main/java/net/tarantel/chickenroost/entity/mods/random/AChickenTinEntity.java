...
public class AChickenTinEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenTinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_TIN.get(), world);
	}

	public AChickenTinEntity(EntityType<AChickenTinEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(ModItems.INGOT_TIN.get());
	}
	@Override
	public void aiStep() {
		super.aiStep();
