...
public class AChickenSulfurEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenSulfurEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_SULFUR.get(), world);
	}

	public AChickenSulfurEntity(EntityType<AChickenSulfurEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:sulfur"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
