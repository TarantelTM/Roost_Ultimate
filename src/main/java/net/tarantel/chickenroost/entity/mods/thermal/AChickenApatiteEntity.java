...
public class AChickenApatiteEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenApatiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_APATITE.get(), world);
	}

	public AChickenApatiteEntity(EntityType<AChickenApatiteEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:apatite"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
