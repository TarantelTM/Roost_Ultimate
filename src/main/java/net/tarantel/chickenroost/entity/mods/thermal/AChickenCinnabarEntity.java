...
public class AChickenCinnabarEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenCinnabarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_CINNABAR.get(), world);
	}

	public AChickenCinnabarEntity(EntityType<AChickenCinnabarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:cinnabar"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
