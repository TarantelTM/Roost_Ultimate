...
public class AChickenUnobtainiumEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenUnobtainiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_UNOBTAINIUM.get(), world);
	}

	public AChickenUnobtainiumEntity(EntityType<AChickenUnobtainiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("allthemodium:unobtainium_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
