...
public class AChickenMekanismBioFuelEntity extends Chicken {
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.withDefaultNamespace("mekanism:elementium_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
		...
		if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && !this.isChickenJockey() && --this.eggTime <= 0) {
			...
			this.spawnAtLocation(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.withDefaultNamespace("botania:elementium_ingot"))));
