...
public class AChickenMekanismBioFuelEntity extends Chicken {
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("mekanism:elementium_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
		...
		if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && !this.isChickenJockey() && --this.eggTime <= 0) {
			...
			this.spawnAtLocation(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("botania:elementium_ingot"))));
