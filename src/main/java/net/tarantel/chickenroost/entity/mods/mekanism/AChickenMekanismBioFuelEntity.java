...
package net.tarantel.chickenroost.entity.mods.mekanism;
...
public class AChickenMekanismBioFuelEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenMekanismBioFuelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_BIO_FUEL.get(), world);
	}

	public AChickenMekanismBioFuelEntity(EntityType<AChickenMekanismBioFuelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("mekanism:elementium_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
		...
		if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && !this.isChickenJockey() && --this.eggTime <= 0) {
			...
			this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("botania:elementium_ingot"))));
