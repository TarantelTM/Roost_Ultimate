...
public class AChickenPigIronEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenPigIronEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_PIG_IRON.get(), world);
	}

	public AChickenPigIronEntity(EntityType<AChickenPigIronEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:pig_iron_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
