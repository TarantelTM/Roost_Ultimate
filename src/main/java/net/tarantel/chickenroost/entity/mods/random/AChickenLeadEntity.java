...
public class AChickenLeadEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenLeadEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_LEAD.get(), world);
	}

	public AChickenLeadEntity(EntityType<AChickenLeadEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(ModItems.INGOT_LEAD.get());
	}
	@Override
	public void aiStep() {
		super.aiStep();
