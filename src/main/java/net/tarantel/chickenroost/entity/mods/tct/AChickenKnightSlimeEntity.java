...
public class AChickenKnightSlimeEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenKnightSlimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_KNIGHT_SLIME.get(), world);
	}

	public AChickenKnightSlimeEntity(EntityType<AChickenKnightSlimeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:apatite"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
