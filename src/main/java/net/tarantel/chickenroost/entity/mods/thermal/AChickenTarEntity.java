...
public class AChickenTarEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenTarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_TAR.get(), world);
	}

	public AChickenTarEntity(EntityType<AChickenTarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:tar"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
