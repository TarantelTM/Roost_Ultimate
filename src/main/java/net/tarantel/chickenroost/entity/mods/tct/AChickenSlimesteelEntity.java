...
package net.tarantel.chickenroost.entity.mods.tct;
...
public class AChickenSlimesteelEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenSlimesteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_SLIMESTEEL.get(), world);
	}

	public AChickenSlimesteelEntity(EntityType<AChickenSlimesteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:slimesteel_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
