...
public class AChickenUraniumEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenUraniumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_URANIUM.get(), world);
	}

	public AChickenUraniumEntity(EntityType<AChickenUraniumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(ModItems.INGOT_URANIUM.get());
	}
	@Override
	public void aiStep() {
		super.aiStep();
