...
public class AChickenAmethystBronzeEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenAmethystBronzeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_AMETHYST_BRONZE.get(), world);
	}

	public AChickenAmethystBronzeEntity(EntityType<AChickenAmethystBronzeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(ModItems.INGOT_BRONZE.get());
	}
	@Override
	public void aiStep() {
		super.aiStep();
