...
package net.tarantel.chickenroost.entity.mods.botania;
...
public class AChickenBotaniaTerrasteelEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBotaniaTerrasteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BOTANIA_TERRASTEEL.get(), world);
	}
	public AChickenBotaniaTerrasteelEntity(EntityType<AChickenBotaniaTerrasteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("botania:terrasteel_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
