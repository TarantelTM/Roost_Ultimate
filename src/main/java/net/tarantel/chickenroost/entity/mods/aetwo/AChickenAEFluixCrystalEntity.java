...
public class AChickenAEFluixCrystalEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenAEFluixCrystalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_AE_FLUIX_CRYSTAL.get(), world);
	}

	public AChickenAEFluixCrystalEntity(EntityType<AChickenAEFluixCrystalEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ae2:fluix_crystal"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
