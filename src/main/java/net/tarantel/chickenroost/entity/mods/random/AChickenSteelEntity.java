...
public class AChickenSteelEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenSteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_MEKANISM_STEEL.get(), world);
	}

	public AChickenSteelEntity(EntityType<AChickenSteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(ModItems.INGOT_STEEL.get());
	}
	@Override
	public void aiStep() {
		super.aiStep();
