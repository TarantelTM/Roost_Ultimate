...
public class AChickenCobaldEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenCobaldEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_COBALD.get(), world);
	}

	public AChickenCobaldEntity(EntityType<AChickenCobaldEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("tconstruct:cobalt_nugget"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
