...
public class AChickenBotaniaLivingwoodEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBotaniaLivingwoodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BOTANIA_LIVINGWOOD.get(), world);
	}

	public AChickenBotaniaLivingwoodEntity(EntityType<AChickenBotaniaLivingwoodEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("botania:livingwood"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
