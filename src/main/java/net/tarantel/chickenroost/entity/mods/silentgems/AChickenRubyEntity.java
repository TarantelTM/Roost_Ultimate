...
public class AChickenRubyEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenRubyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_RUBY.get(), world);
	}

	public AChickenRubyEntity(EntityType<AChickenRubyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("silentgems:ruby"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
