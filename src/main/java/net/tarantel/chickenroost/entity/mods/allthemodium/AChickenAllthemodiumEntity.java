...
package net.tarantel.chickenroost.entity.mods.allthemodium;
...
public class AChickenAllthemodiumEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenAllthemodiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_ALLTHEMODIUM.get(), world);
	}

	public AChickenAllthemodiumEntity(EntityType<AChickenAllthemodiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("allthemodium:allthemodium_ingot"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
