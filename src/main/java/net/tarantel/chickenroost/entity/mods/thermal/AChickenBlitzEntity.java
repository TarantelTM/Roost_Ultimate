...
public class AChickenBlitzEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenBlitzEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_BLITZ.get(), world);
	}

	public AChickenBlitzEntity(EntityType<AChickenBlitzEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:blitz_powder"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
