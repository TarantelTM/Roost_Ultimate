...
public class AChickenCokeEntity extends Chicken {
	public int eggTime = this.random.nextInt(6000) + 6000;
	public AChickenCokeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModEntities.A_CHICKEN_COKE.get(), world);
	}

	public AChickenCokeEntity(EntityType<AChickenCokeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation("thermal:coal_coke"))));
	}
	@Override
	public void aiStep() {
		super.aiStep();
