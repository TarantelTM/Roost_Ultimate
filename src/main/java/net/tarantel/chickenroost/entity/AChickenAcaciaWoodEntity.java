...
public class AChickenAcaciaWoodEntity extends Chicken {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("savanna"),
			new ResourceLocation("windswept_savanna"));

	///private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation(""));

	/*public static void setter(String biome){
		for(Object b : items){
			SPAWN_BIOMES.add(new ResourceLocation((String) b));
		}
	}*/
	///public static Object[] items = SpawnConfig.ITEM_STRINGS.get().toArray();
	/*private static final Set<ResourceLocation> SPAWN_BIOMESS = Set.copyOf(){

	};*/

	//public static Set<ResourceLocation> items = Set.of(new ResourceLocation("savanna_plateau"));


	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
	if(SpawnConfig.Spawn_Acacia.get() == true && SpawnConfig.Spawn_All.get() == true){
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE)
					.add(new MobSpawnSettings.SpawnerData(ModEntities.A_CHICKEN_ACACIA_WOOD.get(), SpawnConfig.Acacia_Spawnweight.get(), SpawnConfig.Acacia_MinGroupsize.get(), SpawnConfig.Acacia_MaxGroupsize.get()));
	}
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.ACACIA_LOG));
	}
	...
	public static void init() {
		SpawnPlacements.register(ModEntities.A_CHICKEN_ACACIA_WOOD.get(), SpawnPlacements.Type.ON_GROUND,
