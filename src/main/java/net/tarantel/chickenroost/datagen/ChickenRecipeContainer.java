...
public class ChickenRecipeContainer {
   ...
   public static ChickenRecipeContainer.Builder builder() {
      return new ChickenRecipeContainer.Builder();
   }
   ...
   public static class Builder {
      ...
      public ChickenRecipeContainer.Builder roost(String foodTag, String output, Integer time) {
      ...
      public ChickenRecipeContainer.Builder breed(String left, String right, String foodTag, String output, Integer time) {
      ...
      public ChickenRecipeContainer build() {
         ...
         if (this.roost != null) {
            c.roost_output = this.roost;
         }

         if (!this.breeding.isEmpty()) {
            c.basic_breeding = this.breeding;
         }
